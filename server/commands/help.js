	...
	execute: (call) => {
		...
		if (param1 == null) {
			helpembed = new Discord.RichEmbed()
				...
				.setColor(0x00AE86)
				.setFooter(`Run by ${message.author.username}`, `${message.author.avatarURL}`)
			...
			message.reply(`\`${params1} \` is not a valid command. Please try \`${pfx}help (command)\` or just \`${pfx}help\``)
		}
