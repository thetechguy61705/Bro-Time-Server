			...
			if (parameter.toLowerCase() === "preview") {
				...
				if (newParameter != null && newParameter != "") {
					...
					if (specifiedColor > -1) {
						...
						call.safeSend("Invalid game specified. Please try out `!info namecolors list` and take one of those games. Prompt cancelled.");
					}
				} else {
					call.requestInput(null, "Please specify the color role you would like to view.", 60000).then((result) => {
